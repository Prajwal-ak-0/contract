...
schema = {
  ...
  "schema": {
    ...
    "properties": {
      "field_value": {
        "type": "string",
        "description": "The value associated with the extracted field."
      },
      "page_number": {
        "type": "string",
        "description": "The page number from which the field was extracted."
      },
      "confidence": {
        "type": "number",
      ...
      "reasoning": {
        "type": "string",
        "description": "Justification for why the field was extracted."
      },
      "proof": {
        "type": "string",
